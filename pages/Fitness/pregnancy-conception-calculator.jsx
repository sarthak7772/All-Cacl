...
const PregnancyConceptionCalculator = () => {
  ...
  return (
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      {/* Left Sidebar - Health & Fitness Tools - Hidden on mobile and tablet, visible on large desktop */}
      ...
      {/* Main Content Area - Fully Responsive */}
       <div className="w-full lg:ml-34 ">
        <div className="max-w-5xl mx-auto px-3 py-4 sm:px-4 sm:py-5 md:px-6 md:py-6 lg:px-8 lg:py-8">  
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden mb-4 sm:mb-5 md:mb-6">
            ...
            <div className="flex flex-col xl:flex-row">
              {/* Input Section */}
              <div className="flex-1 p-4 sm:p-5 md:p-6 xl:border-r border-gray-900">
                <div className="space-y-4 sm:space-y-5">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-3 py-2 sm:py-2.5 text-gray-900 border border-gray-900 rounded-md text-xs sm:text-sm md:text-base focus:outline-none focus:ring-2 focus:ring-gray-900"
                    >
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-3 gap-2 sm:gap-3">
                      <select
                        ...
                        className="px-2 sm:px-3 py-2 sm:py-2.5 text-gray-900 border border-gray-900 rounded-md text-xs sm:text-sm md:text-base focus:outline-none focus:ring-2 focus:ring-gray-900"
                      >
                        {months.map((m) => (
          ...
          <div className="bg-white rounded-lg shadow-lg p-4 sm:p-5 md:p-6 mb-4 sm:mb-5 md:mb-6">
            ...
            <ul className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 text-xs sm:text-sm md:text-base text-gray-700">
              ...
              <li className="flex items-start gap-2 sm:gap-3">
                <span className="text-gray-500 mt-0.5 sm:mt-1">•</span>
                <span className="leading-relaxed">Conception timing can vary by 10%. Understand individuals with similar cycles can conceive at different times</span>
              </li>
              <li className="flex items-start gap-2 sm:gap-3">
                <span className="text-gray-500 mt-0.5 sm:mt-1">•</span>
          ...
          <div className="bg-white rounded-lg shadow-lg p-4 sm:p-5 md:p-6 mb-4 sm:mb-5 md:mb-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 md:gap-6">
              <div className="text-center p-4 sm:p-5 bg-green-50 rounded-lg border border-green-200">
                ...
                <h3 className="font-semibold text-blue-800 mb-2 text-sm sm:text-base">Fertility Planning</h3>
              ...
              <div className="text-center p-4 sm:p-5 bg-purple-50 rounded-lg border border-purple-200">
                <div className="text-3xl sm:text-4xl mb-2 sm:mb-3">🧬</div>
                <h3 className="font-semibold text-purple-800 mb-2 text-sm sm:text-base">Reproductive Health</h3>
                <p className="text-xs sm:text-sm text-gray-700">
