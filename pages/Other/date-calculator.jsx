...
import { Calendar, Plus, Clock, Menu, X } from 'lucide-react';
...
const DateCalculator = () => {
  ...
  return (
    <>
      <Head>
        <title>Date Calculator | Free Online Date Calculation Tool</title>
        <meta
          name="description"
      ...
      <div className="min-h-screen bg-gray-100 flex flex-col">
        ...
        <div 
          id="sidebar"
          className="hidden lg:block fixed top-14 left-0 h-[calc(100vh-3.5rem)] w-64 bg-white shadow-lg overflow-y-auto border-r border-gray-200 z-40"
        >
        ...
        <div className="lg:ml-64 transition-all duration-300">
          <div className="max-w-5xl mx-auto p-3 sm:p-4 lg:p-8 pt-6 lg:pt-8">
            {/* Title Section */}
            <div className="mb-6 lg:mb-8">
              <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
                <Calendar className="w-6 h-6 sm:w-8 sm:h-8 text-gray-900 flex-shrink-0" />
            ...
            <div className="bg-white rounded-lg shadow-lg border border-gray-200 mb-6 lg:mb-8">
              <div className="bg-gray-900 text-white px-4 sm:px-6 py-3 sm:py-4 rounded-t-lg">
              ...
              <div className="p-3 sm:p-4 lg:p-8">
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-3 gap-1 sm:gap-2">
                      <select
                        ...
                        className="p-1.5 sm:p-2 border border-gray-900 rounded focus:outline-none focus:ring-2 focus:ring-gray-900 text-gray-900 text-sm"
                      >
                        {months.map(month => (
                ...
                <div className="mb-4 sm:mb-6">
                  <label className="flex items-center text-gray-900 text-sm sm:text-base">
                    <input
                      ...
                      className="mr-2 w-4 h-4 accent-gray-900 border border-gray-900"
                    />
                ...
                <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
                  <button
                    ...
                    className="bg-gray-900 hover:bg-gray-800 text-white font-bold py-2.5 sm:py-3 px-4 sm:px-8 rounded-lg transition-colors duration-200 text-sm sm:text-base"
                  >
                    Calculate Date Difference
                  </button>
                  <button
                    onClick={clearDaysBetween}
                    className="bg-gray-400 hover:bg-gray-500 text-white font-bold py-2.5 sm:py-3 px-4 sm:px-6 rounded-lg transition-colors duration-200 text-sm sm:text-base"
                  >
                    Clear
                  </button>
                </div>
            ...
            <div className="bg-white rounded-lg shadow-lg border border-gray-200 mb-6 lg:mb-8">
              <div className="bg-gray-900 text-white px-4 sm:px-6 py-3 sm:py-4 rounded-t-lg">
                <h2 className="text-lg sm:text-xl font-bold flex items-center">
                  <Plus className="w-5 h-5 sm:w-6 sm:h-6 mr-2 flex-shrink-0" />
              ...
              <div className="p-3 sm:p-4 lg:p-8">
                ...
                {/* Operation */}
                <div className="mb-4 sm:mb-6">
                  <label className="block text-xs sm:text-sm font-medium text-gray-900 mb-2">Operation</label>
                  <select
                    value={dateAddSubtract.operation}
                    onChange={(e) => handleAddSubtractChange('operation', null, e.target.value)}
                    className="w-full p-1.5 sm:p-2 border border-gray-900 rounded focus:outline-none focus:ring-2 focus:ring-gray-900 text-gray-900 text-sm"
                  >
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-2 sm:gap-4 mb-4 sm:mb-6">
                  <div>
                    <label className="block text-xs sm:text-sm font-medium text-gray-900 mb-2">Years</label>
                    <input
                      type="number"
                      min="0"
                  ...
                  <div>
                    <label className="block text-xs sm:text-sm font-medium text-gray-900 mb-2">Months</label>
                    <input
                      type="number"
                      min="0"
                  ...
                  <div>
                    <label className="block text-xs sm:text-sm font-medium text-gray-900 mb-2">Weeks</label>
                    <input
                      type="number"
                      min="0"
                  ...
                  <div>
                    <label className="block text-xs sm:text-sm font-medium text-gray-900 mb-2">Days</label>
                    <input
                      type="number"
                      min="0"
              ...
              <div className="p-3 sm:p-4 lg:p-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 sm:gap-4 lg:gap-6 mb-4 sm:mb-6">
                  <div className="text-center p-3 sm:p-4 bg-blue-50 rounded-lg">
                    ...
                    <h4 className="font-semibold text-gray-800 mb-1 sm:mb-2 text-sm sm:text-base">Event Planning</h4>
                    <p className="text-xs sm:text-sm text-gray-600">Schedule meetings, deadlines, and important milestones with precision.</p>
                  </div>
                  ...
                  <div className="text-center p-3 sm:p-4 bg-green-50 rounded-lg">
                    ...
                    <h4 className="font-semibold text-gray-800 mb-1 sm:mb-2 text-sm sm:text-base">Age & Duration</h4>
                    <p className="text-xs sm:text-sm text-gray-600">Calculate exact ages, employment lengths, and project durations.</p>
                  </div>
                  ...
                  <div className="text-center p-3 sm:p-4 bg-yellow-50 rounded-lg">
                    <div className="w-10 h-10 sm:w-12 sm:h-12 bg-yellow-100 rounded-full flex items-center justify-center mx-auto mb-2 sm:mb-3">
                      <Plus className="w-5 h-5 sm:w-6 sm:h-6 text-yellow-600" />
                    </div>
                    <h4 className="font-semibold text-gray-800 mb-1 sm:mb-2 text-sm sm:text-base">Future Planning</h4>
                    <p className="text-xs sm:text-sm text-gray-600">Determine future dates for contracts, renewals, and commitments.</p>
                  </div>
                </div>
                ...
                <div className="space-y-3 sm:space-y-4">
                  <div className="border-l-4 border-gray-900 pl-3 sm:pl-4">
                    <h4 className="font-semibold text-gray-800 text-sm sm:text-base">Between Two Dates</h4>
                  ...
                  <div className="border-l-4 border-gray-900 pl-3 sm:pl-4">
                    <h4 className="font-semibold text-gray-800 text-sm sm:text-base">Add/Subtract Time</h4>
                    <p className="text-gray-600 text-xs sm:text-sm">
                  ...
                  <div className="border-l-4 border-gray-900 pl-3 sm:pl-4">
                    <h4 className="font-semibold text-gray-800 text-sm sm:text-base">Business vs Calendar Days</h4>
                    <p className="text-gray-600 text-xs sm:text-sm">
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 sm:p-4 mb-6">
              <div className="flex items-start">
                <div className="flex-shrink-0 w-5 h-5 sm:w-6 sm:h-6 text-yellow-600 mr-2 sm:mr-3 text-lg sm:text-xl">⚠️</div>
                <div>
                  <h3 className="font-semibold text-gray-800 mb-1 text-sm sm:text-base">Accuracy & Limitations</h3>
