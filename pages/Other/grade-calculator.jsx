...
const GradeCalculator = () => {
  ...
  return (
    <>
     <Head>
        <title>Grade Calculator | Free Online Grade Calculation Tool
          </title>
    ...
    <div className="min-h-screen bg-gray-100 flex flex-col">
      ...
      {/* <div className={`fixed top-0 left-0 h-screen w-64 bg-white shadow-lg overflow-y-auto border-r border-gray-200 z-40 transition-transform duration-300 ease-in-out ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0`}> */}
        ...
        <main className="flex-1 bg-white p-4 lg:p-8 overflow-y-auto lg:ml-46">
          <h1 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-4">Grade Calculator</h1>
            ...
            <div>
              ...
              <div className="bg-gray-50 p-4 lg:p-6 rounded-lg mb-6 lg:mb-8 shadow">
                ...
                <button
                  ...
                  className="text-gray-900 mb-6 flex items-center px-4 py-2 rounded-lg border border-dashed border-gray-300 hover:border-gray-900 transition-colors text-sm"
                >
          ...
          {/* Tips */}
          <div className="bg-white border border-gray-200 rounded-lg p-4 lg:p-6 shadow mt-8">
            <h3 className="text-base lg:text-lg font-bold text-gray-900 mb-4">Grade Calculation Tips</h3>
          ...
          {/* Grade Scale */}
          <div className="bg-white border border-gray-200 rounded-lg p-4 lg:p-6 shadow mt-8">
            <h3 className="text-base lg:text-lg font-bold text-gray-900 mb-4">Grade Scale Reference</h3>
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-4 lg:p-6 shadow mt-8">
            <h3 className="text-base lg:text-lg font-bold text-gray-900 mb-4">Understanding Weighted Grade Calculations</h3>
            ...
            <h4 className="font-semibold text-gray-800 mb-3 text-sm lg:text-base">Common Weighting Examples</h4>
            
            <div className="grid md:grid-cols-2 gap-4 mb-4">
              <div className="bg-gray-50 p-4 rounded-lg">
                <h5 className="font-semibold text-gray-800 mb-2">Liberal Arts Course:</h5>
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                <h5 className="font-semibold text-gray-800 mb-2">Science Course:</h5>
                <ul className="text-sm space-y-1 text-gray-700">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-4 lg:p-6 shadow mt-8">
            <h3 className="text-base lg:text-lg font-bold text-gray-900 mb-4">Academic Success Strategies</h3>
            
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <h4 className="font-semibold text-gray-800 mb-3 text-sm lg:text-base">Study Planning Tips</h4>
              ...
              <div>
                <h4 className="font-semibold text-gray-800 mb-3 text-sm lg:text-base">Grade Management</h4>
                <ul className="space-y-2 text-gray-700 text-sm">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-4 lg:p-6 shadow mt-8">
            <h3 className="text-base lg:text-lg font-bold text-gray-900 mb-4">Using Grade Calculators for Academic Planning</h3>
            
            <div className="grid md:grid-cols-3 gap-4 mb-6">
              <div className="text-center p-4 bg-green-50 rounded-lg">
                <div className="text-3xl mb-3">📊</div>
                <h4 className="font-semibold text-gray-800 mb-2 text-sm lg:text-base">Progress Tracking</h4>
              ...
              <div className="text-center p-4 bg-blue-50 rounded-lg">
                <div className="text-3xl mb-3">🎯</div>
                <h4 className="font-semibold text-gray-800 mb-2 text-sm lg:text-base">Goal Setting</h4>
                <p className="text-xs lg:text-sm text-gray-600">
              ...
              <div className="text-center p-4 bg-purple-50 rounded-lg">
                <div className="text-3xl mb-3">📅</div>
                <h4 className="font-semibold text-gray-800 mb-2 text-sm lg:text-base">Strategic Planning</h4>
                <p className="text-xs lg:text-sm text-gray-600">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-4 lg:p-6 shadow mt-8">
            <h3 className="text-base lg:text-lg font-bold text-gray-900 mb-4">History of Academic Grading Systems</h3>
