...
const HoursCalculator = () => {
  ...
  return (
    <>
      <Head>
        <title>Hours Calculator | Free Online Time Calculation Tool</title>
        <meta
          name="description"
      ...
      <div className="min-h-screen bg-gray-100 flex flex-col">
          ...
          <div className="p-0">
            ...
            <a href="/Other/hours-calculator" className="block">
              <div className="flex items-center gap-3 px-4 py-3 bg-gray-200 cursor-pointer border-b border-gray-200 transition-colors">
                <span className="text-xl flex-shrink-0">🕐</span>
                <span className="text-gray-900 font-semibold">Hours Calculator</span>
              </div>
            </a>
        ...
        <main className="lg:ml-64 bg-white p-3 sm:p-4 lg:p-8 overflow-y-auto transition-all duration-300">
          <div className="max-w-7xl mx-auto">
            <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 mb-3 sm:mb-4">Hours Calculator</h1>
            ...
            <div className="bg-gray-50 p-3 sm:p-4 lg:p-6 rounded-lg mb-4 sm:mb-6 lg:mb-8 shadow">
              ...
              <div className="mb-4 sm:mb-6">
                ...
                <select 
                  ...
                  className="w-full p-2 sm:p-3 border border-gray-900 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-gray-900 text-gray-900 text-sm sm:text-base"
                >
                    ...
                    <div>
                      ...
                      <div className="flex gap-2">
                        <input
                          ...
                          className="flex-1 px-2 sm:px-3 py-1.5 sm:py-2 border border-gray-900 rounded-lg text-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-900 text-sm"
                        />
                        <select
                          value={timeCalc.startPeriod}
                          onChange={(e) => setTimeCalc(prev => ({ ...prev, startPeriod: e.target.value }))}
                          className="px-2 sm:px-3 py-1.5 sm:py-2 border border-gray-900 rounded-lg text-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-900 text-sm"
                        >
                  ...
                  <div className="mb-4 sm:mb-6">
                    ...
                    <div className="grid grid-cols-3 gap-1 sm:gap-2 mb-2 sm:mb-3">
                      <select
                        ...
                        className="px-1 sm:px-2 py-1.5 sm:py-2 border border-gray-900 rounded-lg text-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-900 text-xs sm:text-sm lg:text-base"
                      >
                        {months.map(month => (
            ...
            {((activeTab === 'time-calc' && timeCalc.result && timeCalc.result.error) || 
              ...
              <div className="bg-red-100 border border-red-400 text-red-700 px-3 sm:px-4 py-2 sm:py-3 rounded mb-4 sm:mb-6 lg:mb-8 text-xs sm:text-sm">
            ...
            {((activeTab === 'time-calc' && timeCalc.result && !timeCalc.result.error) || 
              (activeTab === 'date-calc' && dateCalc.result && !dateCalc.result.error)) && (
              <div className="bg-white border border-gray-200 rounded-lg p-3 sm:p-4 lg:p-6 mb-4 sm:mb-6 lg:mb-8 shadow">
                <h3 className="text-base sm:text-lg lg:text-xl font-bold text-gray-900 mb-3 sm:mb-4">Time Duration Result</h3>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-2 sm:gap-3">
                      <div className="text-center p-2 sm:p-3 bg-blue-50 rounded-lg">
                        <div className="text-lg sm:text-xl font-bold text-blue-600">{timeCalc.result.totalHours}</div>
                        <div className="text-xs text-gray-600">Total Hours</div>
                      </div>
                      <div className="text-center p-2 sm:p-3 bg-green-50 rounded-lg">
                        <div className="text-lg sm:text-xl font-bold text-green-600">{timeCalc.result.totalMinutes}</div>
                        <div className="text-xs text-gray-600">Total Minutes</div>
                      </div>
                      <div className="text-center p-2 sm:p-3 bg-purple-50 rounded-lg">
                        <div className="text-lg sm:text-xl font-bold text-purple-600">{timeCalc.result.totalDays}</div>
            ...
            {/* Quick Tips */}
            <div className="bg-white border border-gray-200 rounded-lg p-3 sm:p-4 lg:p-6 mb-4 sm:mb-6 lg:mb-8 shadow">
              <h3 className="text-sm sm:text-base lg:text-lg font-bold text-gray-900 mb-3 sm:mb-4">Time Calculation Quick Tips</h3>
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-3 sm:p-4 lg:p-6 mb-4 sm:mb-6 lg:mb-8 shadow">
              <h3 className="text-sm sm:text-base lg:text-lg font-bold text-gray-900 mb-3 sm:mb-4">Understanding Time Calculations</h3>
            ...
            {/* Common Use Cases */}
            <div className="bg-white border border-gray-200 rounded-lg p-3 sm:p-4 lg:p-6 mb-4 sm:mb-6 lg:mb-8 shadow">
              <h3 className="text-sm sm:text-base lg:text-lg font-bold text-gray-900 mb-4 sm:mb-6">Common Use Cases</h3>
              
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 sm:gap-4 lg:gap-6">
                <div className="text-center p-3 sm:p-4 bg-green-50 rounded-lg">
                  <div className="text-2xl sm:text-3xl mb-2 sm:mb-3">💼</div>
                  <h4 className="font-semibold text-gray-800 mb-1 sm:mb-2 text-xs sm:text-sm lg:text-base">Work Hours</h4>
                ...
                <div className="text-center p-3 sm:p-4 bg-blue-50 rounded-lg">
                  <div className="text-2xl sm:text-3xl mb-2 sm:mb-3">📊</div>
                  <h4 className="font-semibold text-gray-800 mb-1 sm:mb-2 text-xs sm:text-sm lg:text-base">Project Planning</h4>
                  <p className="text-xs lg:text-sm text-gray-600">Calculate project timelines and delivery schedules accurately.</p>
                </div>
                
                <div className="text-center p-3 sm:p-4 bg-purple-50 rounded-lg">
                  <div className="text-2xl sm:text-3xl mb-2 sm:mb-3">📅</div>
                  <h4 className="font-semibold text-gray-800 mb-1 sm:mb-2 text-xs sm:text-sm lg:text-base">Event Duration</h4>
            ...
            {/* Time Facts */}
            <div className="bg-gray-900 text-white p-3 sm:p-4 lg:p-6 rounded-lg mb-4 sm:mb-6 lg:mb-8 shadow">
              <h3 className="text-sm sm:text-base lg:text-lg font-bold mb-2 sm:mb-3">Interesting Time Facts</h3>
              <ul className="text-xs sm:text-sm space-y-1.5 sm:space-y-2 opacity-90">
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-3 sm:p-4 lg:p-6 shadow">
              <h3 className="text-sm sm:text-base lg:text-lg font-bold text-gray-900 mb-4 sm:mb-6">Common Work Schedule Examples</h3>
              
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                <div>
                  <h4 className="font-semibold text-gray-900 mb-2 sm:mb-3 text-xs sm:text-sm lg:text-base">Standard Work Shifts</h4>
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 mb-2 sm:mb-3 text-xs sm:text-sm lg:text-base">Part-Time & Flexible</h4>
                  <ul className="text-xs sm:text-sm text-gray-700 space-y-1.5 sm:space-y-2">
